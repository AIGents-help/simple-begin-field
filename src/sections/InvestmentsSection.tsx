...
interface InvestmentsViewProps {
  records: any[];
  refresh: () => void;
  onAddClick: (file?: File, data?: any) => void;
}

const InvestmentsView: React.FC<InvestmentsViewProps> = ({ records, refresh, onAddClick }) => {
  ...
  return (
    <SectionScreenTemplate onAddClick={onAddClick} onRefresh={onRefresh}>
      {(records, _docs, refresh) => (
        <InvestmentsView records={records} refresh={refresh} onAddClick={onAddClick} />
      )}
